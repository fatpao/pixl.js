...
const char * const lang_it_IT[_L_COUNT] = {
    ...
    [_L_APP_SET_LCD_BACKLIGHT] = "Luminosit?",
    [_L_APP_SET_LCD_BACKLIGHT_TITLE] = "Luminosit? schermo",
    ...
    [_L_DELETE_ALL_DATA] = "Questo canceller? tutti i dati.\nConferma la formattazione?",
    ...
    [_L_NOT_AMIIBO_FILE] = "Questo non ? un file\nAmiibo valido",
    ...
    [_L_COMPATIBLE_MODE] = "Mod. Compatibilit?",
    ...
    [_L_APP_CHAMELEON_CARD_ADV_CUSTOM_MODE] = "Modalit? personalizzata",
    ...
    [_L_APP_CHAMELEON_CARD_WRITE_MODE] = "Modalit? scrittura",
