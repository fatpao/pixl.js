...
const char * const lang_zh_TW[_L_COUNT] = {
    ...
    [_L_APP_SET_DFU] = "軟體升級",
    [_L_APP_SET_REBOOT] = "重新啟動",
    [_L_APP_SET_RESET_DEFAULT] = "還原為預設值",
    [_L_APP_SET_RESET_DEFAULT_SUCCESS] = "還原成功",
    [_L_APP_SET_RESET_DEFAULT_CONFIRM] = "確認還原為預設值？",
    [_L_APP_SET_ABOUT] = "關於設備",
    [_L_APP_SET_ABOUT_OPEN_SOURCE_PROJECT] = "開源項目",
    [_L_APP_SET_ABOUT_LGPL_LICENSE] = "GPL 2.0 授權",
    [_L_APP_SET_APP_MGMT] = "程式管理",
    [_L_15S] = "15秒",
    [_L_30S] = "30秒",
    [_L_45S] = "45秒",
    [_L_1MIN] = "1分鐘",
    ...
    [_L_NOT_MOUNTED] = "未安裝",
    [_L_MOUNTED_LFS] = " ===已安裝[LFS]=== ",
    [_L_MOUNTED_FFS] = " ===已安裝[FFS]=== ",
    [_L_TOTAL_SPACE] = "總空間",
    ...
    [_L_CREATE_NEW_FOLDER] = "新增資料夾...",
    [_L_CREATE_NEW_TAG] = "新增標籤...",
    [_L_CREATE_NEW_TAG_BATCH] = "批次新增標籤...",
    [_L_INPUT_TAG_NUM] = "輸入標籤數量：",
    [_L_CREATE_TOO_MANY_NUM] = "一次最多只能創建%d個標籤",
    [_L_CREATING_TAG_BATCH] = "新增標籤",
    [_L_CREATING_TAG_FAILED] = "新增 %s 標籤失敗",
    [_L_RENAME] = "重新命名...",
    ...
    [_L_APP_AMIIDB_SETTINGS_AMIIBO_KEY_LOADED] = "已載入",
    [_L_APP_AMIIDB_SETTINGS_AMIIBO_KEY_NOT_LOADED] = "未載入",
    [_L_APP_AMIIDB_SETTINGS_SLOT_NUM] = "數據槽位",
    [_L_APP_AMIIDB_DETAIL_FAVORITE] = "收藏...",
    [_L_APP_AMIIDB_DETAIL_SAVE_AS] = "儲存爲...",
    [_L_APP_AMIIDB_DETAIL_BACK_DETAIL] = "[返回詳情]",
    [_L_APP_AMIIDB_DETAIL_BACK_LIST] = "[返回列表]",
    [_L_APP_AMIIDB_SEARCH_HEAD] = "搜尋：",
    [_L_APP_AMIIDB_MORE] = "[更多]",
    [_L_APP_AMIIDB_MORE_MESSAGE] = "搜尋結果過多，嘗試增加搜尋詞。",
    [_L_APP_AMIIDB_EMPTY_TAG] = "<空標籤>",
    [_L_APP_AMIIDB_SLOT_DELETE] = "還原...",
    [_L_APP_AMIIDB_CONFIRM] = "確認",
    [_L_APP_AMIIDB_CANCEL] = "取消",
    [_L_APP_AMIIDB_TIPS] = "提示",
    [_L_APP_AMIIDB_NEW] = "新增...",
    [_L_APP_AMIIDB_EMPTY] = "清除...",
    [_L_APP_AMIIDB_DELETE] = "删除...",
    [_L_APP_AMIIDB_FAV_NEW_HEAD] = "新增收藏夾：",
    [_L_APP_AMIIDB_FAV_EMPTY_MSG] = "確認清除收藏夾?",
    ...
    [_L_APP_AMIIDB_SLOT_SAVE_SUCCESS] = "儲存成功",
    [_L_APP_AMIIDB_SLOT_SAVE_FAILED] = "儲存失敗",
    [_L_APP_AMIIDB_SORT_FIELD] = "排序欄位",
    [_L_APP_AMIIDB_SORT_DEFAULT] = "預設",
    [_L_APP_AMIIDB_SORT_NAME] = "名稱",
    [_L_APP_AMIIDB_NOT_SUPPORT_V3] = "暫時不支持V3 amiibo！",
    [_L_APP_CHAMELEON] = "卡片模擬器",
    ...
    [_L_APP_CHAMELEON_TAG_MF1_WRITE_SHADOW] = "快取",
    [_L_APP_CHAMELEON_INITIALIZING] = "初始化, 請稍後...",
    [_L_APP_CHAMELEON_CARD_SLOT] = "卡片槽位",
    [_L_APP_CHAMELEON_CARD_NICK] = "卡片名稱",
    [_L_APP_CHAMELEON_CARD_ID] = "ID",
    [_L_APP_CHAMELEON_CARD_TYPE] = "卡片類型",
    [_L_APP_CHAMELEON_CARD_DATA] = "卡片數據...",
    [_L_APP_CHAMELEON_CARD_ADVANCED] = "卡片進階設定...",
    [_L_APP_CHAMELEON_CARD_SLOT_SETTINGS] = "卡片槽位管理...",
    [_L_APP_CHAMELEON_CARD_SLOT_NUM] = "卡片槽位數量...",
    [_L_APP_CHAMELEON_CARD_SET_NICK_SUCCESS] = "設定卡片名稱成功",
    [_L_APP_CHAMELEON_CARD_SET_NICK_FAILED] = "設定卡片名稱失敗",
    [_L_APP_CHAMELEON_CARD_INPUT_NICK] = "輸入卡片名稱：",
    [_L_APP_CHAMELEON_CARD_DATA_LOAD] = "讀取...",
    [_L_APP_CHAMELEON_CARD_DATA_SAVE] = "儲存…",
    [_L_APP_CHAMELEON_CARD_DATA_FACTORY] = "還原...",
    ...
    [_L_APP_CHAMELEON_CARD_DATA_LOAD_SUCCESS] = "讀取卡片數據成功",
    [_L_APP_CHAMELEON_CARD_DATA_SAVE_INPUT_FILE_NAME] = "輸入文件名",
    [_L_APP_CHAMELEON_CARD_DATA_SAVE_FAILED] = "儲存文件失敗",
    [_L_APP_CHAMELEON_CARD_DATA_SAVE_SUCCESS] = "儲存卡片數據成功",
    [_L_APP_CHAMELEON_CARD_ADV_CUSTOM_MODE] = "自定義模式",
    [_L_APP_CHAMELEON_CARD_ADV_LOAD_BLOCK0] = "載入0扇區數據…",
    [_L_APP_CHAMELEON_CARD_ADV_LOAD_BLOCK0_SUCCESS] = "載入0扇區數據成功",
    ...
    [_L_APP_CHAMELEON_CARD_TYPE_FACTORY_DATA_CONFRIM] = "卡片類型已修改\n還原卡片數據?",
    [_L_APP_CHAMELEON_CARD_DEFAULT_CARD] = "預設卡片",
    [_L_APP_GAME] = "遊戲",
