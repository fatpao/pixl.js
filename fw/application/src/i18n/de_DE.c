...
const char * const lang_de_DE[_L_COUNT] = {
    ...
    [_L_APP_SET_RESET_DEFAULT_SUCCESS] = "Einstellungen zur?ckgesetzt!",
    [_L_APP_SET_RESET_DEFAULT_CONFIRM] = "Auf Standardeinstellungen zur?cksetzen?",
    [_L_APP_SET_ABOUT] = "",
    ...
    [_L_2MIN] = "2 Minuten",
    [_L_3MIN] = "3 Minuten",
    [_L_AMIIBO_KEY_UNLOADED] = "Amiibo Schl?ssel fehlt",
    [_L_UPLOAD_KEY_RETAIL_BIN] = "Platzieren Sie die Datei key_retail.bin im Hauptverzeichnis des Speichers.",
    [_L_KNOW] = "Verstanden",
    [_L_RANDOM_GENERATION] = "Zuf?llige UUID",
    [_L_AUTO_RANDOM_GENERATION] = "Zuf?llige UUID (Automatisch)",
    [_L_SET_CUSTOM_ID] = "",
    [_L_INPUT_ID] = "",
    [_L_INAVLID_ID] = "",
    [_L_SHOW_QRCODE] = "QR Code",
    [_L_READ_ONLY] = "",
    [_L_DELETE_TAG] = "Tag l?schen",
    [_L_DELETE_TAG_CONFIRM] = "L?schen von %s best?tigen?",
    [_L_BACK_TO_DETAILS] = "Zur?ck zu Tag Details",
    [_L_BACK_TO_FILE_LIST] = "Zur?ck zur Liste",
    [_L_BACK_TO_MAIN_MENU] = "Hauptmen?",
    [_L_FORMAT] = "Formatieren",
    [_L_FORMAT_STORAGE] = "Speicher formatieren",
    [_L_DELETE_ALL_DATA] = "Alle Daten l?schen?",
    [_L_DELETING_MESSAGE] = "Formatiere...",
    [_L_MESSAGE] = "Meldung",
    [_L_CONFIRM] = "Best?tigen",
    [_L_CANCEL] = "Abbrechen",
    [_L_BACK_TO_LIST] = "Zur?ck zur Liste",
    ...
    [_L_DELETE_FILE] = "%s l?schen ?",
    [_L_DELETE] = "L?schen...",
    [_L_TIPS] = "Best?tigen",
    [_L_INPUT_NEW_NAME] = "Neuen Namen eingeben:",
    [_L_INVALID_INPUT] = "Ung?ltige Eingabe",
    ...
    [_L_CREATE_TOO_MANY_NUM] = "Sie k?nnen nur maximal %d Tags auf einmal erstellen.",
    [_L_CREATING_TAG_BATCH] = "Tag erstellen",
    [_L_CREATING_TAG_FAILED] = "Erstellen von Tag %s fehlgeschlagen!",
    [_L_RENAME] = "Umbenennen...",
    [_L_OPEN_FOLDER_FAILED] = "Ordner konnte nicht ge?ffnet werden",
    [_L_RENAME_FAILED] = "Umbenennen fehlgeschlagen\nFehlercode",
    [_L_MAIN_RETURN] = "[Zur?ck]",
    [_L_RANDOM_MODE_MANUAL] = "Zuf?llige UUID (Manuell)",
    [_L_RANDOM_MODE_AUTO] = "Zuf?llige UUID (Automatisch)",
    ...
    [_L_AMILOOP] = "AmiLoop",
    [_L_MODE] = "Modus",
    [_L_AUTO_RANDOM] = "Zuf?llige UUID (Automatisch)",
    [_L_COMPATIBLE_MODE] = "Kompabilit?ts Modus",
    [_L_TAG_DETAILS] = "[Zur?ck zu Details]",
    [_L_MAIN_MENU] = "[Hauptmen?]",
    [_L_MODE_RANDOM] = "Zuf?llige UUID (Manuell)",
    [_L_MODE_CYCLE] = "Sequentiell",
    [_L_MODE_NTAG] = "Lesen/Schreiben",
    [_L_MODE_RANDOM_AUTO_GEN] = "Zuf?llig (Auto.)",
    ...
    [_L_APP_AMIIDB_BACK] = "[Zur?ck]",
    [_L_APP_AMIIDB_SETTINGS_AMIIBO_KEY] = "Schl?ssel",
    ...
    [_L_APP_AMIIDB_DETAIL_BACK_DETAIL] = "[Zur?ck zu Details]",
    [_L_APP_AMIIDB_DETAIL_BACK_LIST] = "[Zur?ck zur Liste]",
    ...
    [_L_APP_AMIIDB_SLOT_DELETE] = "Zur?cksetzen...",
    [_L_APP_AMIIDB_CONFIRM] = "Best?tigen",
    [_L_APP_AMIIDB_CANCEL] = "Abbrechen",
    [_L_APP_AMIIDB_TIPS] = "Best?tigen",
    [_L_APP_AMIIDB_NEW] = "Neu...",
    [_L_APP_AMIIDB_EMPTY] = "Leeren...",
    [_L_APP_AMIIDB_DELETE] = "L?schen...",
    [_L_APP_AMIIDB_FAV_NEW_HEAD] = "Neuer Fav.-Ordner:",
    [_L_APP_AMIIDB_FAV_EMPTY_MSG] = "Fav.-Ordner leeren?",
    [_L_APP_AMIIDB_FAV_DELETE_MSG] = "L?schen Best?tigen?",
    [_L_APP_AMIIDB_FAV_SELECT_FOLDER] = "Fav.-Ordner ausw?hlen...",
    ...
    [_L_APP_CHAMELEON_CARD_DATA_FACTORY] = "Zur?cksetzen...",
    [_L_APP_CHAMELEON_CARD_DATA_FACTORY_SUCCESS] = "Daten zur?ckgesetzt",
    [_L_APP_CHAMELEON_CARD_DATA_LOAD_NOT_FOUND] = "Datei nicht gefunden",
    [_L_APP_CHAMELEON_CARD_DATA_LOAD_SIZE_NOT_MATCH] = "Dateigr??e stimmt nicht ?berein",
    ...
    [_L_APP_CHAMELEON_CARD_GENERATE_UID] = "Zuf?llige UID",
    ...
    [_L_APP_CHAMELEON_CARD_ADV_ID_EDIT_INVALID_INPUT] = "Ung?ltige Eingabe!",
    [_L_APP_CHAMELEON_CARD_TYPE_FACTORY_DATA_CONFRIM] = "Kartentyp ge?ndert. \nKartendaten zur?cksetzen?",
