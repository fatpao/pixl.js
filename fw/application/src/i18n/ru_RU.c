...
const char * const lang_ru_RU[_L_COUNT] = {
    ...
    [_L_APP_SET_ABOUT_LGPL_LICENSE] = "???????? GPL 2.0",
    [_L_15S] = "15 ??????",
    [_L_30S] = "30 ??????",
    [_L_45S] = "45 ??????",
    [_L_1MIN] = "1 ??????",
    ...
    [_L_CREATING_TAG_FAILED] = "?????? ???????? ???? %s",
    [_L_RENAME] = "?????????????...",
    [_L_OPEN_FOLDER_FAILED] = "?????? ???????? ?????",
    [_L_RENAME_FAILED] = "?????? ??????????????",
    [_L_MAIN_RETURN] = "[?????]",
    [_L_RANDOM_MODE_MANUAL] = "?????? ????????? UUID",
    [_L_RANDOM_MODE_AUTO] = "????????????? UUID",
    [_L_SEQUENCE_MODE] = "????????????????",
    [_L_READ_WRITE_MODE] = "??????-??????",
    [_L_AMIIBOLINK_V1] = "V1",
    [_L_AMIIBOLINK_V2] = "V2",
    ...
    [_L_APP_CHAMELEON_CARD_GENERATE_UID] = "????????????? UID",
    [_L_APP_CHAMELEON_CARD_GENERATE_UID_SUCCESS] = "UID ????????????",
